...
import math
T_a = float(input("Please enter the temperature in degrees Celsius:"))
V = float(input("Please enter wind speed in kilometers per hour: "))

term = math.pow(V, 0.16)
WCI = 13.12 + 0.6215 * T_a - 11.37 * term + 0.3965 * T_a * term
