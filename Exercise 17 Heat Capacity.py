...
volume = float(input("Please enter the amount of water in milimeters: "))
d_temp = float(input("Please enter the temperature increase in degree celcius: "))

water_heat_capacity = 4.186

amount_of_energy = volume * d_temp * water_heat_capacity

print("Total amount of energy required, ",amount_of_energy)

# Computing the cost

electricity_cost = 8.9
joules_to_kilowatthour = 2.777e-7
kilowatthour = amount_of_energy * joules_to_kilowatthour
cost = kilowatthour * electricity_cost

print("This much energy will require the cost of {}".format(cost))
