...
if value % 2 == 1 and value >=1 and value <= 9 or value % 2 == 0 and value >=12 and value <= 18 or value % 2 == 0 and value >=19 and value <= 27 or value % 2 == 0 and value >=30 and value <= 36:
  print("Pay Red")
