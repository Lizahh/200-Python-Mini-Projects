...
user_input = input("Please enter the name of a music note, like A4 etc.")
...
# Then divide the frequency by 2^(4-x) , where x is the octave number entered by the user. This will halve or double the frequency the correct number of times.

freq = freq / 2 ** (4 - octave)
print("Frequency of {} is {}".format(user_input, freq))
